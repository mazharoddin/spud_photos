module Spud
  module Photos
    ...
    config_accessor :photo_styles, :convert_options, :galleries_enabled, :base_layout, :base_path,:s3_credentials,:storage_path,:storage_url,:paperclip_storage, :enable_full_page_caching
    self.photo_styles = {
      :small => '50x50#',
      :medium => '200x200#',
      :large => '400x400#'
